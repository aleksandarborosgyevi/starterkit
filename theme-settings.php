...
function STARTERKIT_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['STARTERKIT_block_demo_mode'] = array(
    '#type' => 'checkbox',
    ...
    '#default_value' => theme_get_setting('STARTERKIT_block_demo_mode', $theme),
    '#group' => 'debug',
  );
  ...
  $form['#validate'][] = 'STARTERKIT_disable_twig_cache';

}

function STARTERKIT_disable_twig_cache(&$form, \Drupal\Core\Form\FormStateInterface $form_state) {
